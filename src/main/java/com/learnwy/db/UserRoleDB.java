...
public class UserRoleDB {
    public static List<UserRole> getUserRoles() {
        ...
        String sql = "select distinct user_role_id ,user_id ,role_id from user_role";
    ...
    public static UserRole getUserRoleById(long id) {
        String sql = "select distinct user_role_id ,user_id ,role_id  from user_role where user_role_id = " + id;
        ResultSet rs = MySQL.excuteSQL(sql);
        UserRole user_role = null;
        try {
            if (rs.next()) {
    ...
    public static int delUserRole(long user_id, long role_id) {
        String sql = "delete from user_role where user_id = " + user_id + " and role_id =" + role_id;
        return MySQL.updateSQL(sql);
    }

    public static int addUserRole(long user_id, long role_id) {
